...
public class FODCircleViewImpl extends SystemUI implements CommandQueue.Callbacks {
    ...
    public void start() {
        ...
        boolean hasFod = mContext.getResources().getBoolean(
            com.android.internal.R.bool.config_hasFod);
        if (!packageManager.hasSystemFeature(PackageManager.FEATURE_FINGERPRINT) || !hasFod) {
            return;
        }
